...
start:
  switch i64 %rhs, label %bb5.i.i [
    i64 0, label %_ZN17evolve_inner_core3i6426evolve_i64_safe_rem_option17h817943717d465a59E.exit
    i64 -1, label %bb2.i.i
  ]

bb2.i.i:                                          ; preds = %start
  br label %_ZN17evolve_inner_core3i6426evolve_i64_safe_rem_option17h817943717d465a59E.exit

bb5.i.i:                                          ; preds = %start
  %0 = srem i64 %lhs, %rhs
  br label %_ZN17evolve_inner_core3i6426evolve_i64_safe_rem_option17h817943717d465a59E.exit

_ZN17evolve_inner_core3i6426evolve_i64_safe_rem_option17h817943717d465a59E.exit: ; preds = %start, %bb2.i.i, %bb5.i.i
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(none)
define { i64, i64 } @_ZN17evolve_inner_core3i6426evolve_i64_safe_rem_option17h817943717d465a59E(i64 noundef %lhs, i64 noundef %rhs) unnamed_addr #7 {
start:
...
bb3:                                              ; preds = %bb4.i, %bb5.i, %bb6.i, %bb5.i.i.i, %start
  %_0.sroa.3.0 = phi ptr [ null, %start ], [ null, %bb4.i ], [ %spec.select2, %bb5.i ], [ %2, %bb5.i.i.i ], [ null, %bb6.i ]
  %_0.sroa.0.0 = phi i64 [ 257, %start ], [ 257, %bb4.i ], [ %spec.select3, %bb5.i ], [ 4, %bb5.i.i.i ], [ 4, %bb6.i ]
  %6 = insertvalue { i64, ptr } poison, i64 %_0.sroa.0.0, 0
...
bb6.i:                                            ; preds = %bb4.i
  %cond = icmp eq ptr %right.1, inttoptr (i64 -1 to ptr)
  br i1 %cond, label %bb3, label %"_ZN4core3num21_$LT$impl$u20$i64$GT$10rem_euclid17hf4b279eb79a0c0c8E.exit.i.i.i"

"_ZN4core3num21_$LT$impl$u20$i64$GT$10rem_euclid17hf4b279eb79a0c0c8E.exit.i.i.i": ; preds = %bb6.i
  %_12.i = ptrtoint ptr %left.1 to i64
...
bb5.i:                                            ; preds = %bb4.i
  ...
  %spec.select3 = select i1 %_29.not.i, ptr %_2.i2, ptr null
  %spec.select4 = select i1 %_29.not.i, i64 5, i64 257
  br label %bb3

bb3:                                              ; preds = %bb4.i, %bb5.i, %bb6.i, %"_ZN4core3num21_$LT$impl$u20$i64$GT$10rem_euclid17hf4b279eb79a0c0c8E.exit.i.i.i", %start
  %_0.sroa.3.0 = phi ptr [ null, %start ], [ null, %bb4.i ], [ %spec.select3, %bb5.i ], [ %2, %"_ZN4core3num21_$LT$impl$u20$i64$GT$10rem_euclid17hf4b279eb79a0c0c8E.exit.i.i.i" ], [ null, %bb6.i ]
  %_0.sroa.0.0 = phi i64 [ 257, %start ], [ 257, %bb4.i ], [ %spec.select4, %bb5.i ], [ 4, %"_ZN4core3num21_$LT$impl$u20$i64$GT$10rem_euclid17hf4b279eb79a0c0c8E.exit.i.i.i" ], [ 4, %bb6.i ]
  %6 = insertvalue { i64, ptr } poison, i64 %_0.sroa.0.0, 0
  %7 = insertvalue { i64, ptr } %6, ptr %_0.sroa.3.0, 1
  ret { i64, ptr } %7
}
